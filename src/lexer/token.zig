pub const TokenType = enum {
    ...
    U128, // u128
    Usize, // usize
    Uint, // uint (shorthand for u32)
    F16, // f16
    F32, // f32
    F64, // f64
    F128, // f128
    Float, // float (shorthand for f32)

    // ── other built-in types ──────────────────────────────────────────────
    Bool, // bool
    Char, // char
    Void, // void  — function returns nothing
    Noret, // noret — like a diverging function, never returns
    Any, // any   — holds any type of value
    Str, // str   — stack-allocated string slice
    ...
    Error, // error
    Struct, // struct
    Behave, // behave  — for traits / interfaces
    Ext, // ext     — short for extern
    Func, // func
    Pub, // pub     — marks something as publicly visible
    ...
    Loop, // loop    — infinite loop (use break to get out)
    Ret, // ret     — return statement
    Break, // break
    Skip, // skip    — like continue in other languages
    Try, // try
    Catch, // catch
    Defer, // defer
    Test, // test
    ...
    EndComment, // end of a comment line
    Equals, // =
    ColonEquals, // :=
    PlusEquals, // +=
    MinusEquals, // -=
    ...
    DotDotEquals, // ..=
    At, // @
    NA, // invalid / unrecognised token
    EOF, // end of file
};

// characters that can be part of an operator
pub const OPERATORS = [_]u8{ '=', '+', '-', '*', '/', '%', '!', '&', '|', '^', '~', '<', '>', '?', '@', ':' };
// characters that act as separators between tokens
